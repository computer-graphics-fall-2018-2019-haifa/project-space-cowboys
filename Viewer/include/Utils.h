...
public:
	...
	static glm::vec3 transformVertic(const glm::vec3 vertic, glm::mat4 transformMetrix, int w, int h);
	/************************************************************************/
	/* Matrices                                                           */
	/************************************************************************/
	...
	static glm::mat4 setFinallTransformMat(glm::mat4 worldTrans, glm::mat4 localTrans, glm::mat4 cameraTrans, glm::mat4 cameraProjection);
private:
